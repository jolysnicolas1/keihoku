          ...
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                ...
                <li className="flex gap-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-netral-700">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                </svg>
                <div>
                  <div>
                    Mardi 20 février <strong className="font-semibold text-neutral-700">de 14:30 à 18:30</strong>
                  </div>
                  <div>
                    Mercredi 21 & jeudi 22 février <strong className="font-semibold text-neutral-700">de 10:00 à 18:30</strong>
                  </div>
                  <div>
                    Vendredi 23 février <strong className="font-semibold text-neutral-700">de 10:00 à 17:30</strong>
                  </div>
                </div>
                </li>
                <li className="flex gap-x-3">
