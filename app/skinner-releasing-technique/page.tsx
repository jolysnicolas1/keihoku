                ...
                <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                    <div className="lg:pr-4">
                        <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                            <p>
                                Le stage s&apos;adresse à toute personne
                                désireuse d&apos;approfondir la pratique du
                                mouvement.
                            </p>
                            <ul
                                role="list"
                            ...
                            <p className="mt-6">
                                La Skinner Releasing est une méthode de danse
                                improvisée, plaçant l&apos;imagination dynamique
                                au cœur de l&apos;apprentissage. Des images
                                poétiques viennent éveiller, susciter, altérer,
